		...
		Axios({
			...
			.then((res) => {
				if (res.data.success) {
					...
					document.querySelector('.notify').innerHTML = '<p>waad is diwaan galisay mahadsanid</p>';
					...
					document.querySelector('.notify').innerHTML = '<p>khadka ayaa kaa xun!</p>';
					document.querySelector('.notify').style.height = '5vh';
					document.querySelector('.notify').style.overflow = 'hidden';
					document.querySelector('.notify').style.background = 'red';
			...
			<div>
				...
				<form className="form" onSubmit={this.handleSubmit}>
					...
					<div>
						...
						<input type="submit" className="button" value="IS DIWAN GALI" />
					</div>
					......................................................
					<a
